...
import fr.strada.smobile.ui.spi.ui.tms.adapter.TourneeListAdapter
 ...
 * Use the [ListTournerFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ListTournerFragment : Fragment() {
    @Inject
    internal lateinit var providerFactory: ViewModelProviderFactory
    lateinit var viewModel: TmsActivityViewModel

    lateinit var adapterList: TourneeListAdapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_list_tourner, container, false)
    }
    ...
    private fun initViewRecycler() {
        adapterList = TourneeListAdapter(listItem) {
            val action = ListTournerFragmentDirections.actionListTournerFragmentToDetailTourneeFragment(it)
            findNavController().navigate(action)
        }
        recyclerI_item_tournee.apply {
            adapter = adapterList
    ...
    companion object {
        fun newInstance() = ListTournerFragment()
