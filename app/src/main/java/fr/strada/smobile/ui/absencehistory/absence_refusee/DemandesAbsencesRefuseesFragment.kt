 ...
 */
class DemandesAbsencesRefuseesFragment : BaseNFragment() {

    private val monthYearReceiver = MonthYearReceiver()
    var recyclerView: RecyclerView? = null
    var layoutNoAbsences: ConstraintLayout? = null
    private val viewModel: DemandesAbsencesRefuseesViewModel by lazy {
        DemandesAbsencesRefuseesViewModel()
    }
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_demandes_absences_refusees, container, false)
        return view
    }
    ...
    private fun initRecyclerView(view: View) {
        ...
        recyclerView.apply {
            ...
            this?.adapter = DemandesAbsencesRefuseesAdapter(context, viewModel.getAbsenceRefused())
        }
    }
