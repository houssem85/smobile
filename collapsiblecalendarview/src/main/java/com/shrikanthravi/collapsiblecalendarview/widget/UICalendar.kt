...
abstract class UICalendar constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ScrollView(context, attrs, defStyleAttr) {
    ...
    protected fun setAttributes(attrs: TypedArray) {
        ...
        isInitiable= attrs.getBoolean(R.styleable.UICalendar_isInitiable, isInitiable)
        isCollapsible= attrs.getBoolean(R.styleable.UICalendar_isCollapsible, isCollapsible)
        isShowSeparator= attrs.getBoolean(R.styleable.UICalendar_isShowSeparator, isShowSeparator)
